...
<head>
  <meta charset="utf-8">
  <title>Home v1: Landing Page | Frexy Responsive HTML Template</title>
...
<body>
  <header>
    <div class="container b-header__box b-relative">
      <a href="/" class="b-left b-logo "><img class="color-theme" data-retina src="<?php bloginfo('template_url'); ?>/img/logo-header-default.png" alt="Logo" /></a>
          ...
          <li>
              <div class="b-option-cart__items__img">
                  <div class="view view-sixth">
                      <img data-retina="" src="<?php bloginfo('template_url'); ?>/img/shop/cart_mini_pic.jpg" alt="">
